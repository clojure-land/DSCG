...
str generateResultClassString(TrieSpecifics ts) {
	...
	"static final class <classNameStr><GenericsStr(ts.tupleTypes)> {
		private <typeToString(__internal__dsAtFunction__range_type(ts))> replacedValue;
		...
		public void updated(<typeToString(__internal__dsAtFunction__range_type(ts))> replacedValue) {
		...
		public <typeToString(__internal__dsAtFunction__range_type(ts))> getReplacedValue() {
